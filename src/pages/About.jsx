  ...
  return (
    <section className="w-full bg-gradient-to-br from-blue-50 via-white to-blue-50 overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        {/* Image Left Side (Zoom Focused on Doctor) */}
        <motion.div
        ...
        >
          <motion.img
            src="/images/dr-zohaib-about.jpg"
            alt="Dr. Zohaib Buzdar - About"
            className="w-full max-w-sm rounded-2xl shadow-2xl border-4 border-blue-600 object-cover object-[50%_20%] transition-transform duration-700"
